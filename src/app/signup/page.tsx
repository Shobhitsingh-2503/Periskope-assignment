    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F9F9F7]">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="flex flex-col items-center justify-center">
          ...
          <h2 className="text-2xl font-bold text-[#5a6473]">Create an Account</h2>
          <p className="text-sm text-gray-500 mt-2">Join Periskope to start chatting</p>
        </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            ...
            <a href="/login" className="font-medium text-[#6caf85] hover:text-[#4c9d67]">
              Sign in
            </a>
          </p>
        </div>
